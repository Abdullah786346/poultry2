        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <div className="text-sm text-amber-500">Society for  Excellence</div>
              </div>
            </div>
            ...
            {/* Social Media Links */}
            <div className="mt-6">
              <h4 className="font-bold text-lg mb-3 text-gray-800">Follow Us</h4>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-amber-500 transition-colors">About Us</a></li>
              <li><a href="#" className="text-gray-600 hover:text-amber-500 transition-colors">Membership</a></li>
              <li><a href="#" className="text-gray-600 hover:text-amber-500 transition-colors">Research</a></li>
              <li><a href="#" className="text-gray-600 hover:text-amber-500 transition-colors">Events</a></li>
              <li><a href="#" className="text-gray-600 hover:text-amber-500 transition-colors">Resources</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <address className="text-gray-600 not-italic space-y-2">
              <div className="flex items-start">
                ...
                <a href="mailto:poultryprofessionalsociety@gmail.com" className="hover:text-amber-500 transition-colors">
              ...
              <div className="flex items-start">
                ...
                <a href="tel:+923024684453" className="hover:text-amber-500 transition-colors">
                  +923024684453
                </a>
              </div>
            </address>
          ...
          <div>
            ...
            <div className="flex mb-3">
              <input 
                ...
                className="px-4 py-2 rounded-l-lg w-full text-gray-800 focus:outline-none focus:ring-2 focus:ring-amber-500 border border-gray-300"
              />
              <button className="bg-amber-500 hover:bg-amber-600 px-4 rounded-r-lg transition-colors text-white font-semibold">
                Subscribe
              </button>
            </div>

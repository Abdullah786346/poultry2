        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              />
              <div>
                <div className="text-xl font-bold text-[#714616]">Poultry Professionals Society  </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-[#545454] hover:text-[#de0f3f] transition-colors">About Us</a></li>
              <li><a href="#" className="text-[#545454] hover:text-[#de0f3f] transition-colors">Membership</a></li>
              <li><a href="#" className="text-[#545454] hover:text-[#de0f3f] transition-colors">Research</a></li>
              <li><a href="#" className="text-[#545454] hover:text-[#de0f3f] transition-colors">Events</a></li>
              <li><a href="#" className="text-[#545454] hover:text-[#de0f3f] transition-colors">Resources</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex mb-3">
              ...
              />
              <button className="bg-[#de0f3f] hover:bg-[#c10e38] px-4 rounded-r-lg transition-colors text-white font-semibold">
                Subscribe
              </button>
            </div>

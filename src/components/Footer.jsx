    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              <div className="bg-amber-600 text-white font-bold text-xl p-2 rounded mr-3">PPS</div>
              <span className="ml-1 text-xl font-bold">Poultry Professionals Society</span>
            </div>
          ...
          <div>
            ...
            <div className="flex mb-3">
              ...
              />
              <button className="bg-amber-600 hover:bg-amber-700 px-4 rounded-r-lg transition-colors">
                Subscribe
              </button>
            </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
          <p>© 2023 Poultry Professionals Society. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
